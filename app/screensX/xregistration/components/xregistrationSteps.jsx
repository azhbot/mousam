...
const XregistrationSteps = () => {
  return (
    <>
      <View style={styles.container}>
        <View style={styles.box}>
          <View style={[styles.circle, { borderColor: colors.tertiary }]}>
            <CustomLabel color={colors.tertiary}>1</CustomLabel>
          </View>
        ...
        <View style={styles.box}>
          <View style={styles.circle}>
            <CustomLabel color={colors.LightGray}>2</CustomLabel>
          </View>
          <CustomLabel fontSize={12} style={styles.label}>
            Password Creation
          </CustomLabel>
...
export default XregistrationSteps;
