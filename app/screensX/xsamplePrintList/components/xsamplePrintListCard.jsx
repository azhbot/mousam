...
const XsamplePrintListCard = ({
  ...
  const company = {
    name: sampleInvoice?.companyName || "Unknown Company",
    logo: sampleInvoice?.companyLogo || null,
  };
    ...
    >
      ...
      <View style={styles.container}>
        <View style={styles.containerTop}>
          <View style={styles.topLeft}>
            ...
            <View style={styles.rowCenter}>
              ...
              <CustomLabel
                ...
                style={{ flex: 0.3 }}
              >
                {sampleInvoice?.productVariant},{" "}
                {sampleInvoice?.productSize || "N/A"}
              </CustomLabel>
            </View>
          ...
          <View style={styles.topRight}>
            <View style={styles.qrCode}>
              <Qrcode value={sampleInvoice?.id} size={width * 0.2} />
            </View>
        ...
        <View style={styles.idAndDate}>
          <CustomLabel fontSize={10}>ID: {sampleInvoice?.id}</CustomLabel>
...
export default XsamplePrintListCard;
