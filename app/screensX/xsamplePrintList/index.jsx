...
import XsamplePrintListCard from "./components/xsamplePrintListCard";
...
import { selectCompanySamplesInvoices } from "../../redux/sample/sampleSelector";

const XsamplePrintListScreen = () => {
  ...
  const sampleInvoices = useSelector(selectCompanySamplesInvoices);

  // useEffect(() => {
  //   console.log(sampleInvoices, "in xorderverifiedlist");
  // }, [sampleInvoices]);
...
export default XsamplePrintListScreen;
