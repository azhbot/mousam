...
import { selectManufacturerInvoices } from "../../redux/order/orderSelector";
...
const OrderInvoiceScreen = () => {
  ...
  const manufacturerOrderInvoices = useSelector(selectManufacturerInvoices);

  useEffect(() => {
    console.log(manufacturerOrderInvoices?.length, "in xorderverifiedlist");
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {manufacturerOrderInvoices.length === 0 ? (
        <View style={styles.empty}>
          <CustomLabel color={colors.gray}>No Order Invoices</CustomLabel>
        </View>
      ) : (
        <FlatList
          data={manufacturerOrderInvoices || []}
