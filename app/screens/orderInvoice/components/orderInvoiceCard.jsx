        ...
        <View style={styles.containerTop}>
          <View style={styles.topLeft}>
            ...
            <View style={styles.rowCenter}>
              ...
              <CustomLabel fontSize={12} style={{ flex: 0.3 }}>
                {verifiedOrder?.productMfgCategory}
              </CustomLabel>
            </View>
            <View style={styles.rowCenter}>
            ...
            <View style={styles.rowCenter}>
              ...
              <CustomLabel
                ...
                style={{ flex: 0.3 }}
              >
                {verifiedOrder?.productVariant},{verifiedOrder?.productSize}
              </CustomLabel>
            </View>
          ...
          <View style={styles.topRight}>
            <View style={styles.qrCode}>
              <Qrcode id={verifiedOrder?.id} width={width * 0.2} />
            </View>
